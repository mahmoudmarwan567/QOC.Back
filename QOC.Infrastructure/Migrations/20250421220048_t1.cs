        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ButtonTextEN = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    SocialNameAR = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    SocialNameEN = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ProjectNameAR = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ProjectNameEN = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ProjectDescriptionAR = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ProjectDescriptionEN = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ProjectPropertiesAR = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ProjectPropertiesEN = table.Column<string>(type: "nvarchar(max)", nullable: false),
